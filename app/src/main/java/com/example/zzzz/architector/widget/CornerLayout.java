...
public class CornerLayout extends LinearLayout {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        mCenterX = getWidth() / 2;
        //画圆及阴影
        mPaint.setShadowLayer(1, 1, 1, getContext().getResources().getColor(R.color.blue_shadow));
        ...
        //画线段
        mPaint.setShadowLayer(1, 0, 1, getContext().getResources().getColor(R.color.blue_shadow));
        canvas.drawLine(mRadius, mRectHeight - 1, getWidth() - mRadius, mRectHeight - 1, mPaint);
        //画三角形
        mPath = new Path();
